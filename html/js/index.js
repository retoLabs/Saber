...
import utils from '/saber/k1/libK3_Utils.js'
import sess from '/saber/k1/libK3_Sesion.js'
...
function modSwitch(ok,tipo){
	...
	switch(utils.vgk.user.rol){
		case 'SYSTEM' :
			...
			break;
		case 'ADMIN' :
			window.location = 'inicio.html?idSess='+utils.vgk.sesion_id;
			break;
		case 'TESTS' :
...
En el evento CLICK del botón de login, se invoca la funcion validaUser (libK3_Sesion.js) con los valores de user,pwd
